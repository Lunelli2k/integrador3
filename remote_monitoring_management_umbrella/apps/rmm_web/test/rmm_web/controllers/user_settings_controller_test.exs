defmodule RmmWeb.UserSettingsControllerTest do
  ...
  describe "PUT /user/settings (change email form)" do
    ...
    test "updates the user email", %{conn: conn, user: user} do
      ...
      assert Entidades.get_user_by_email(user.email)
    end
  ...
  describe "GET /user/settings/confirm_email/:token" do
    ...
    test "updates the user email once", %{conn: conn, user: user, token: token, email: email} do
      ...
      refute Entidades.get_user_by_email(user.email)
      assert Entidades.get_user_by_email(email)
