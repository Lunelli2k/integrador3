defmodule Rmm.EstruturasDeDados.Entidades.RegraEventoCriticidade do
  ...
  def changeset(regra_evento_criticidade, attrs) do
    ...
    |> cast(attrs, [:descricao, :tipo_evento_criticidade, :condicao, :propriedade_verificar, :valor_propriedade, :prioridade, :impacto])
    |> validate_required([:descricao, :tipo_evento_criticidade, :condicao, :propriedade_verificar, :valor_propriedade, :prioridade, :impacto])
  end
end
